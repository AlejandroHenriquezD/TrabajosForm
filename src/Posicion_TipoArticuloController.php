...
class Posicion_TipoArticuloController
{
    public function __construct(private Posicion_TipoArticuloGateway $gateway)
    {}
    ...
    private function processResourceRequest(string $method, string $id): void
    {
        ...
        if ( ! $tipoarticulo) {
            ...
            echo json_encode(["message" => "Posicion-Articulo no encontrada"]);
            return;
        }
        ...
        switch ($method) {
            ...
            case "PATCH":
                ...
                echo json_encode([
                    "message" => "Posicion-Articulo $id actualizada",
                    "rows" => $rows
                ]);
                break;
            ...
            case "DELETE":
                ...
                echo json_encode([
                    "message" => "Posicion-Articulo $id borrada",
                    "rows" => $rows
                ]);
                break;
            default:
    ...
    private function processCollectionRequest(string $method): void
    {
        switch ($method){
            ...
            case "POST":
                ...
                echo json_encode([
                    "message" => "Posicion-Articulo Creada",
                    "id" => $id
                ]);
                break;
