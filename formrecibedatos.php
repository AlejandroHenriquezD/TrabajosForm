...
{
    $tiposTrabajos = json_decode(file_get_contents("http://localhost/trabajosform/tipos_trabajos.php"), true);
...
{
    $tiposArticulos = json_decode(file_get_contents("http://localhost/trabajosform/tipos_articulos.php"), true);
