...
for ($a = 0; $a < $numeroTipoArticulos; $a++) {
  ...
  $arrayTipoArticulos .= "<input type='radio' class=\"articuloRadio-codigoArticulo\" id=\"tipoArticulo-codigoArticulo-{$tiposArticulos[$a]['id']}\" name=\"articuloRadio-codigoArticulo\" value=\"{$tiposArticulos[$a]['nombre']}\" onclick='mostrarTrabajos(\"form-control-codigoArticulo-{$tiposArticulos[$a]['id']}\")'>";
...
// Trabajos
$trabajos = "<div class='trabajos' id=\"trabajos-codigoArticulo-tiposArticulos\"><h1>Trabajos</h1><div class='coleccionHorizontal'>";
for ($t = 0; $t < $numeroTrabajos; $t++) {
  $trabajos .= "<div id=\"form-control-codigoArticulo-tiposArticulos-{$tiposTrabajos[$t]['id']}\">";
  $trabajos .= "<label for=\"trabajo-codigoArticulo-tiposArticulos-{$tiposTrabajos[$t]['id']}\">";
  $trabajos .= "<input type='checkbox' id=\"trabajo-codigoArticulo-tiposArticulos-{$tiposTrabajos[$t]['id']}\" name={$tiposTrabajos[$t]['nombre']} value={{$tiposTrabajos[$t]['nombre']}} onclick='mostrarPosiciones(\"form-control-codigoArticulo-tiposArticulos-{$tiposTrabajos[$t]['id']}\")'>";
...
// Posiciones
for ($a = 0; $a < $numeroTipoArticulos; $a++) {
  $posiciones[$a] = "<div class='posicion' id=\"posicion-codigoArticulo-{$tiposArticulos[$a]['id']}-idTiposTrabajos\"><div class='seleccionado'><h1>nombreTiposTrabajos</h1></div><h1>Posiciones: </h1><div class='coleccionHorizontal'>";
  for ($p = 0; $p < $numeroPosicionesArticulos; $p++) {
    ...
    if ($posicionesArticulos[$p]['id_tipo_articulo'] == $tiposArticulos[$a]['id']) {
      ...
      $posiciones[$a] .= "<div id=\"form-control-codigoArticulo-{$tiposArticulos[$a]['id']}-idTiposTrabajos-{$posicionesArticulos[$p]['id_posicion']}\">";
      $posiciones[$a] .= "<label for=\"posicion-codigoArticulo-{$tiposArticulos[$a]['id']}-idTiposTrabajos-{$posicionesArticulos[$p]['id_posicion']}\">";
      $posiciones[$a] .= "<input type='checkbox' id=\"posicion-codigoArticulo-{$tiposArticulos[$a]['id']}-idTiposTrabajos-{$posicionesArticulos[$p]['id_posicion']}\" class='posicion-checkbox' name='posicion-checkbox[]' value=\"form-control-codigoArticulo-{$tiposArticulos[$a]['id']}-idTiposTrabajos-{$posicionesArticulos[$p]['id_posicion']}\" onclick='mostrarLogos(\"form-control-codigoArticulo-{$tiposArticulos[$a]['id']}-idTiposTrabajos-{$posicionesArticulos[$p]['id_posicion']}\")'>";
...
// Logos
for ($o = 0; $o < $numeroPedidos; $o++) {
  $arrayLogos[$o] = "<div class='logos' id='logos-{$pedidos[$o]['SeriePedido']}-{$pedidos[$o]['NumeroPedido']}-codigoArticulo-idTipoArticulo-idTiposTrabajos-idPosicion'>";
